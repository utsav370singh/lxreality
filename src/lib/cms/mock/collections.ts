...
export const leaders: Leader[] = [
  ...
  },
  {
    ...
    bio: "Abhishek co-founded LX Realty and leads its sales organisation across 25+ cities, building high-performing teams and long-term developer relationships.",
    order: 2,
  },
  {
    id: "l-shobha-sharma",
    name: "Shobha Sharma",
    role: "CFO and Director Legal & Compliances",
    photo: avatar("leader-shobha", "Shobha Sharma", 400),
    linkedin: "https://www.linkedin.com/in/lxrealty-shobha",
    bio: "Shobha oversees LX Realty's finance function and all legal and regulatory compliance, ensuring every transaction is sound, transparent and fully documented.",
    order: 3,
  },
  {
    id: "l-anirudh-chhoker",
    name: "Anirudh Chhoker",
    role: "Business Head Sales",
    photo: avatar("leader-anirudh", "Anirudh Chhoker", 400),
    linkedin: "https://www.linkedin.com/in/lxrealty-anirudh",
    bio: "Anirudh heads the sales business, translating market data into decisions clients can act on with confidence.",
    order: 4,
  },
];
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    order: 1,
    quote:
      "The team helped us pick a plot with clear titles and genuine appreciation potential. Every document was verified and explained before we signed anything.",
    name: "Karan Malhotra",
    role: "Investor, Gurugram",
    photo: avatar("t-karan-2", "Karan Malhotra", 160),
    rating: 5,
  },
];
...
export const perspectives: Insight[] = [
  ...
  {
    id: "pv-anirudh",
    slug: "perspective-anirudh-chhoker",
    ...
    image: avatar("leader-anirudh", "Anirudh Chhoker", 600),
    kind: "perspective",
    author: "Anirudh Chhoker",
    authorRole: "Business Head Sales",
    authorPhoto: avatar("leader-anirudh", "Anirudh Chhoker", 200),
    topics: ["Technology", "Market Trends"],
    body: LOREM_BODY,
  },
  {
    id: "pv-shobha",
    slug: "perspective-shobha-sharma",
    title: "Transparency and compliance will define the next era",
    category: "Leadership Perspective",
    date: "2024-05-04",
    excerpt:
      "Transparency, trust, and rigorous compliance will define the next era of real estate in India.",
    image: avatar("leader-shobha", "Shobha Sharma", 600),
    kind: "perspective",
    author: "Shobha Sharma",
    authorRole: "CFO and Director Legal & Compliances",
    authorPhoto: avatar("leader-shobha", "Shobha Sharma", 200),
    topics: ["Technology"],
    body: LOREM_BODY,
  },
];
